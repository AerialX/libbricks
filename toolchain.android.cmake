...
set( PossibleArmTargets "armeabi;armeabi-v7a;armeabi-v7a with NEON;armeabi-v7a with VFPV3;x86" )
...
elseif( ARM_TARGET STREQUAL "x86" )
  set( ARMEABI_NDK_NAME "x86" )
...
Supported values are: \"armeabi\", \"armeabi-v7a\", \"armeabi-v7a with NEON\", \"armeabi-v7a with VFPV3\", \"x86\"
" )
 endif()
...
#  set( STL_LIBRARIES_PATH "${ANDROID_NDK_TOOLCHAIN_ROOT}/${ARM_PREFIX}/lib/${CMAKE_SYSTEM_PROCESSOR}/thumb" )
# endif()
endif()

if( BUILD_WITH_ANDROID_NDK_TOOLCHAIN )
 set( STL_LIBRARIES_PATH "${ANDROID_NDK_TOOLCHAIN_ROOT}/${ARM_PREFIX}/lib" )
 if( NOT ARMEABI )
...
set( LINKER_FLAGS "-L\"${STL_LIBRARIES_PATH}\" -L\"${CMAKE_INSTALL_PREFIX}/libs/${ARMEABI_NDK_NAME}\" -lstdc++ -lsupc++" )
if( NOT X86 )
