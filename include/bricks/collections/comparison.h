...
namespace Bricks { namespace Collections {
	...
	template<typename T>
	class OperatorValueComparison<T, typename SFINAE::EnableIf</*SFINAE::HasEqualityOperator<T>::Value &&*/ SFINAE::HasGreaterThanOperator<T>::Value && SFINAE::HasLessThanOperator<T>::Value>::Type> : public Object, public ValueComparison<T>
	{
	public:
