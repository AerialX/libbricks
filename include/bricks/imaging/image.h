...
namespace Bricks { namespace Imaging {
	...
	public:
		...
		virtual void CopyTo(Image* image, u32 x = 0, u32 y = 0) const;
		virtual void CopyTo(Image* image, u32 x, u32 y, u32 width, u32 height) const;

		void ColouriseTo(Image* image, const Colour& colour) const;
