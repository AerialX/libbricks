...
if (NOT DEFINED ARMEABI)
	set (ARMEABI true)
endif()

if (NOT DEFINED ARMEABI_V7A)
	if (APPLE)
		set (ARMEABI_V7A true)
	else()
		set (ARMEABI_V7A false)
	endif()
endif()
if (NOT APPLE AND ARMEABI_V7A)
	set (ARMEABI_V7A false) # Linux toolchain fail
endif()
...
set (LINKER_FLAGS "-L${IOS_SDK_SYSROOT}/usr/lib/gcc/${IOS_SDK_TARGET}/${IOS_SDK_TARGET_VERSION} -L${IOS_SDK_SYSROOT}/usr/lib/system -bind_at_lead -lgcc -lobjc -lstdc++")

#set (CMAKE_FIND_ROOT_PATH "${IOS_SDK_BINPATH}" "${IOS_SDK_TOOLCHAIN_ROOT}/${IOS_SDK_TARGET}" "${IOS_SDK_BINPATH}" "${CMAKE_INSTALL_PREFIX}" "${CMAKE_INSTALL_PREFIX}/share")

set (CMAKE_FIND_ROOT_PATH_MODE_PROGRAM ONLY)
set (CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
set (CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)

set (CMAKE_C_FLAGS "-fPIC -D__APPLE__ -fsigned-char")
...
#set (CMAKE_FIND_ROOT_PATH "${IOS_SDK_SYSROOT}" "${CMAKE_INSTALL_PREFIX}")
